...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_tabs_js__WEBPACK_IMPORTED_MODULE_2__["default"])(".balcon_icons", ".balcon_icons_img", ".big_img>img", "do_image_more", 0, "inline-block");
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modalState);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])(".container1", "2022-07-08");
...
function modal(triggerSelector, modalSelector, closeSelector) {
  ...
  var end = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 0;
  var modalTrigger = document.querySelectorAll(triggerSelector);
  var modal = document.querySelector(modalSelector);
  var modalCloseBtn = document.querySelector(closeSelector);
...
function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  var startTab = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;
  ...
  function showTabContent() {
    var i = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : startTab;
  ...
  header.addEventListener("click", function (e) {
    ...
    if (target.classList.contains(tabSelector.replace(/\./, "")) || target.closest(tabSelector).classList.contains(tabSelector.replace(/\./, ""))) {
...
var timer = function timer(id, deadline) {
  var fake = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
