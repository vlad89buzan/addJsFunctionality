...
window.addEventListener("DOMContentLoaded", () => {
  ...
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_11__["default"])('.pageup'); // drop();
});
...
__webpack_require__.r(__webpack_exports__);
const drop = () => {
  //drag * sobutiya kotorue srabatuvaut na pertaskivaem elemente
  //dragend * sobutiya kotorue srabatuvaut na pertaskivaem elemente
  //dragenter - object nad drop area
  //dragexit * sobutiya kotorue srabatuvaut na pertaskivaem elemente
  //dragleave -object za predelami droparea
  //dragover - object nad droparea
  //dragstart * sobutiya kotorue srabatuvaut na pertaskivaem elemente
  //drop -otpushena knopka mushi i object v droparea
